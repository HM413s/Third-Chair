    ...
    <section className="container px-4 py-24">
      ...
      <div className="max-w-2xl mb-20">
        <h2 className="text-5xl md:text-6xl font-normal mb-6 tracking-tight text-left">
          Fix Document Issues
          <br />
          <span className="text-gradient font-medium">With One Click</span>
        </h2>
        <p className="text-lg md:text-xl text-gray-400 text-left">
          Advanced AI agents designed to detect and instantly fix document inconsistencies, formatting issues, and inefficiencies for legal professionals.
        </p>
      </div>
